...
| Count Selections | Checked(input '1' or 'true' - case insensitive) - The input will show the number of selected items. Unchecked(input '0' or 'false' - case insensitive) - The input will show the text of the selected items, separated by comma.Supports My Tokens. | Yes | None |
| Maximum Number of Selections |  If this option is set, the user will be able to select this maximum number of checkboxes.Supports My Tokens. | Yes | None |
