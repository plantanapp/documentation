...
| Interval Length | Subscription interval length. The interval length must be 7 to 365 days or 1 to 12 months. Can contain My Tokens. | Yes | None |
| Interval Unit | Subscription interval unit. Days or Months. Can contain My Tokens. | Yes | 0 |
...
| Trial Occurrences | Optional. Number of occurrences for the trial period of the subscription. If a trial period is specified, this number should include the trial occurrences. Can contain My Tokens. | Yes | None |
