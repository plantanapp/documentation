...
This action creates a list in the current context from the result of the provided SQL Query. You can find the number of loaded list items in the `[<ListName>:Count]` token.
