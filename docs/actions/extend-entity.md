...
- Create an entity. Use [Add List Entry](/actions/add-list-entry.md) or any of the `Load Entities (Source)` actions instead (e.g. [Create List from CSV file (obsolete)](/actions/create-list-from-csv-file-obsolete.md)).
