...
sidebar_label: Add Number Input
---
...
| Field Title | Required. Give this field an title/name which is a label. Supports My Tokens. | Yes | None |
...
| Maximum Value | Optionally set a maximum value.Supports My Tokens. | Yes | None |
