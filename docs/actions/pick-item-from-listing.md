...
## `Configuring the Listing Module`

The Listing Module must be configured with the Data Table view enabled and displayed by default (it must be the top-most enabled view).
