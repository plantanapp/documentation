...
| -- | -- | -- | -- |
| Container Id | This is the Container Id to place this Multiple Choice with Dropdown into. Eg. Add a Dynamic Field Container having id DynamicFieldContainer. "DynamicFieldContainer" is the ID of the field. Supports Tokens. | No | None |
...
| Number of items | The number of elements initially displayed after a search. On scroll, more elements matching the search term will be displayed (default 50).Supports Tokens. | No | None |
| Disable dropdown on click | It will only appear when you start typing.Supports Tokens. | No | None |
