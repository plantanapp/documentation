...
### `1. Selecting the first user and storing it's data in the variable "user"`

This action selects all the details of the first user and stores them in a variable named `user` for further use.
